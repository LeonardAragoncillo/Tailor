...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mr-4">
                        <li class="nav-item">
                            <a class="nav-link" href="../user/homepage.html" style="color: #000000; padding-right: 20px;">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../user/appointment.html"
                                style="color: #000000; padding-right: 20px;">Appointment</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../user/myorders.html" style="color: #000000; padding-right: 20px;">My
                                Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="signup.html" style="color: #000000; padding-right: 20px;">Account</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="signup.html" style="color: #000000; padding-right: 20px;">Logout</a>
                        </li>
                        <style>
                            .nav-link {
    ...
    <section>
        <div class="intro">
            <div class="phrase">
                ...
                <h4>Where you can effortlessly schedule your ultimate fitting experience and <br>explore personalized
                ...
                <div class="container">
                    ...
                    <button type="button" class="btn btn-primary" id="button" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop"> <a href="../user/appointment.html" style="text-decoration: none; color: #000000;">
    ...
    <div class="services">
        <h1 style="text-align: center; padding: 15px; padding-top: 15px;">Our Services</h1>
        <div class="carousel">
    ...
    <div class="footer">
        <h1 style="padding-top: 30px; text-align: center; font-weight: 700; padding-bottom: 30px;">Visit Shop Today</h1>
    </div>
    <div class="details">
        <div class="hours">
